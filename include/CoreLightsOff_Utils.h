...
#define COW_CORELIGHTSOFF_VERSION_MINOR    "6"
#define COW_CORELIGHTSOFF_VERSION_REVISION "1"

#define COW_CORELIGHTSOFF_VERSION       \
    COW_CORELIGHTSOFF_VERSION_MAJOR "." \
    COW_CORELIGHTSOFF_VERSION_MINOR "." \
    COW_CORELIGHTSOFF_VERSION_REVISION
